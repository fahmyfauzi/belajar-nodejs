...
const app = express();
const { loadContact, detailContact, addContact, cekDuplikat, deleteContact, updateContact } = require('./utils/contact');
...
app.get('/contact/edit/:nama', (req, res) => {
  ...
  if (!contact) {
    ...
    res.render('edit-contact', { layout: 'layouts/main-layout', contact, title: 'Halaman Edit Contact' });
  }
});
